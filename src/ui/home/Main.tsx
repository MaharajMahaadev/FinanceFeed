...
export default function Main(){
    return(
        <>
            <img src="banner.jpg" alt="Banner Image" className="w-[100vw] h-[100vh]" />
            <div className="absolute content-center justify-items-center text-center top-0 pt-20 left-0 bg-background/85 w-full h-full">
                ...
                <p className="font-semibold text-xl m-2 my-6 text-pretty">Get information regarding all the latest companies from US stock market, get an estimation of 
                    their future stock prices using Machine Learning technologies and read the trending news affecting the 
                    stocks, it&aposs technology and cryptos.
                </p>
            </div>
        </>
    )
